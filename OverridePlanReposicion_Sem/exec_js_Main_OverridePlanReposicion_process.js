...
const logFileName = 'Override_PlanReposicion_Sem';
...
async function IniciaejecutarArchivos() {
  ...
  writeToLog(`Proceso de Override del Plan de Reposicion Semanal\n`);
  ...
  writeToLog(`\n\n`);
  writeToLog(`Terminan el Proceso de Override del Plan de Reposicion Semanal: ${now_fin}\n`);
}
