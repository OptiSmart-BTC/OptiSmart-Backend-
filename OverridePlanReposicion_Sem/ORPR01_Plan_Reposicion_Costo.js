...
const logFile = `../../${parametroFolder}/log/Override_PlanReposicion_Sem.log`; 
...
async function actualizarDatos() {
  //writeToLog('------------------------------------------------------------------------------');
  writeToLog(`\nPaso 01 - Recalculo del Plan de Reposicion en Costo Semanal`);
  ...
  writeToLog(`\tTermina el Recalculo del Plan de Reposicion en Costo Semanal`);
  } catch (error) {
    // Manejar el error
