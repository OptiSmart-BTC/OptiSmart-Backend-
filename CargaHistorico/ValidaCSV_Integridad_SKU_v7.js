...
const csvPath = `../../${parametroFolder}/reportes/HistDemanda_SKU_No_Encontrados.csv`;
...
async function main() {
  ...
  writeToLog(`\nPaso 08 - Validacion de Integridad de los SKU.`);
  ...
  try {
    ...
    const ColeccionRespaldo = db.collection('report_sin_sku_histdemand_vs_sku');
