...
async function IniciaejecutarArchivos() {
  ...
  const archivosClasificacion = [
    ...
    { nombre: 'C09.1_Calcula_Desviacion_estandar.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
  ...
  const archivosPoliticasCompleto = [
    ...
    { nombre: 'P05.1_Calcula_DS.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
