...
const sourceCollectionName1 = 'politica_inventarios_01'; 

const targetCollectionName1 = 'politica_inventarios_01_backup'; //Limpiar la tabla antes de meter el backup
...
//------------------------------------------------------------------------------------
const sourceCollectionName = 'ui_all_pol_inv'; 

const targetCollectionName = 'ui_all_pol_inv_backup'; //Limpiar la tabla antes de meter el backup
