...
const productosUbicaciones = `${documentos.Producto}@${documentos.Ubicacion}`;

const formattedResult = JSON.stringify(productosUbicaciones, null, 2);
writeToLog(formattedResult);

   /* 
const skusNoEncontrados = await collectionName.find({
