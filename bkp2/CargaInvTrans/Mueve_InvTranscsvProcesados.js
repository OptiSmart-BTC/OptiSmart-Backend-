...
const sourcePath = `../../${parametroFolder}/csv/inventario_transito.csv`;
...
function main() {
  ...
  //writeToLog(`\n`);
  writeToLog(`\nPaso 04 - Mueve Archivo Cargado a Procesados`);
  ...
  const newFileName = `inventario_transito_${timestamp}${fileExtension}`;
