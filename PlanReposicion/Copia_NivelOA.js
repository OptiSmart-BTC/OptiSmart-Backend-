...
async function copiarNivelOA() {
  console.log('\n🟢 INICIO: Copia de Nivel_OA y Origen_Abasto desde colección `sku` hacia `plan_reposicion_01`\n');
  ...
  try {
    ...
    const planRepo = db.collection('plan_reposicion_01');
    ...
    for (const sku of skuData) {
      ...
      if (result.modifiedCount > 0) {
        ...
        totalFallidos++;
        console.log(`⚠️  ${expectedSKU} no encontrado en plan_reposicion_01`);
      }
    }
