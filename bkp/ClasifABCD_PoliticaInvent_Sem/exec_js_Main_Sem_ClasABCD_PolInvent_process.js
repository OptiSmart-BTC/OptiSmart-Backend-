...
async function IniciaejecutarArchivos() {
  ...
  const archivos = [
    ...
    { nombre: 'CS04_Calcula_Demanda_Costo.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'CS11_Calcula_Variabilidad_Demanda.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'CS12_Calcula_DS_Demanda.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'CS13_Calcula_Coeficiente_Variabilidad.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'CS17.1_Calcula_Clasificación_ABCD_v2.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'PS05_Calcula_Variabilidad_Demanda_Cantidad.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'PS06_Calcula_Nivel_Servicio.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'PS07_Calcula_CamposSKU_v2.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'PS10_Calcula_SS_Cantidad_v2.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'PS13_Calcula_ROP.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'PS15.1_Calcula_Stat_SS.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
