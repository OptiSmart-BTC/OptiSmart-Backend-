...
async function IniciaejecutarArchivos() {
  ...
  const archivos = [
    { nombre: 'ORS01_ReCalcula_Override_SI_NO.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'ORS02_ReCalcula_SS_Cantidad.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
