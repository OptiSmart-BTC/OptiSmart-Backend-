...
//inventario_disponible.csv
    const InvDispocsvFilePath = `../../${parametroFolder}/templetes/templete-inventario_disponible.csv`;
    ...
    const InvTranscsvFilePath = `../../${parametroFolder}/templetes/templete-inventario_transito.csv`;
    ...
    const RequConfcsvFilePath = `../../${parametroFolder}/templetes/templete-requerimientos_confirmados.csv`;
