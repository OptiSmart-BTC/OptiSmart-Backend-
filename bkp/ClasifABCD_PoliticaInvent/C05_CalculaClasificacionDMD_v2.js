...
async function actualizarClasificacionDemanda() {
  ...
  writeToLog(`\nPaso 05 - Calculo de la Clasificacion de la Demanda`);
    ...
    try {
      ...
      const demandaOrdenadaDescCollection = db.collection('demanda_ordenada_desc');
      ...
      writeToLog(`\tTermina el Calculo de la Clasificacion de la Demanda`);
    } catch (error) {
