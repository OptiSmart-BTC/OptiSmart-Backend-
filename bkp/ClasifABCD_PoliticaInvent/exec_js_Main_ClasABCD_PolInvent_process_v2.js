...
async function IniciaejecutarArchivos() {
  ...
  const archivos = [
    ...
    { nombre: 'C01_Calcula_Demanda_Costo.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'C08_Calcula_Variabilidad_Demanda_v2.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'C09_Calcula_DS_Demanda.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'C10_Calcula_Coeficiente_Variabilidad.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'C14.1_Calcula_Clasificación_ABCD_v2.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'P07_Calcula_CamposSKU_v2.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'P10_Calcula_SS_Cantidad_v2.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'P13_Calcula_ROP.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    ...
    { nombre: 'P15.1_Calcula_Stat_SS.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'P16_Formatea_TablaUI.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
    { nombre: 'P17_Calcula_Dias_Cobertura.js', parametros: `${dbName} ${DBUser} ${passadminDeCripta}` },
