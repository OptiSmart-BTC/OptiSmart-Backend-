...
const filePath = `../../${parametroFolder}/csv/inventario_disponible.csv`;
...
const movedFilePath = `${tempFolderPath}/inventario_disponible_org_${now}.csv`;
...
writeToLog(`\tValidacion de Encoding del archivo inventario_disponible.csv realizada con exito.\n`);
