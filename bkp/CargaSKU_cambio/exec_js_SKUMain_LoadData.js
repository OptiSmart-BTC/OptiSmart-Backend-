...
const { AppUser, AppPassword, Tipo, DBUser, DBPassword, DBName } = require(`../../${parametroFolder}/cfg/${parametroUsuario}.uservars`);
...
const parametroFolder = DBName.toUpperCase();
...
const archivos = [
  ...
  { nombre: 'ValidaCSV_SKU_TipodeDato_v7.js', parametros: `${parametroFolder}` },
  { nombre: 'loadCSVsku_v8.js', parametros: `${dbName} ${parametroFolder} ${AppUser}` },
  { nombre: 'Mueve_SKUcsvProcesados.js', parametros: `${parametroFolder}` },
  { nombre: 'LimpiaEspaciosSKU_v3.js', parametros: `${dbName} ${parametroFolder} ${AppUser}` },
  { nombre: 'CsvTempl_sku.js', parametros: `${dbName} ${parametroFolder} ${AppUser}` },
];
