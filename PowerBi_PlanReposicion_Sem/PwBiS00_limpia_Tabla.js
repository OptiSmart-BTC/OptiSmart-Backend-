...
const logFile = `${path_users}/${parametroFolder}/log/PowerBI_PlanReposicion_Sem.log`; // Cambia esta ruta según la ubicación de tu archivo CSV
...
const collectionsToDelete = [
  'powerbi_plan_reposicion_01_sem',
];
