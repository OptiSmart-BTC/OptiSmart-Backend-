...
const filePath = `${UserPath}/powerbi_plan_reposicion_sem.csv`;
...
async function exportToCsv() {
  ...
  try {
    ...
    const collection = db.collection('powerbi_plan_reposicion_01_sem');
    ...
    const fields = [
      ...
      'Demanda_Promedio_Semanal', 'Inventario_Promedio', 'Costo_A', 'Costo_B', 'Costo_C', 
