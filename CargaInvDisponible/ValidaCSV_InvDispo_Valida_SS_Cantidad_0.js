...
const csvPath = `../../${parametroFolder}/reportes/InvDisp_PolInv_SKU_SS_Cantidad_0.csv`;
...
async function main() {
  ...
  writeToLog(`\nPaso 09 - Validacion del SS Cantidad en 0 de la Politica de Inventarios.`);
  ...
  try {
    ...
    const ColeccionRespaldo = db.collection('report_invdisp_vs_polinv_ss_cantidad_0');
    ...
    writeToLog(`\tSe encontraron ${skusNoEncontradosIds.length} registros en el Inventario Dsiponible cargado con problemas de Integridad de SKUs`);
