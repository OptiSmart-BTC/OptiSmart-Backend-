...
async function actualizarDatos() {
  //writeToLog('------------------------------------------------------------------------------');
  writeToLog(`\nPaso 02.1 - Actualizacion de Descripciones SKU`);
  ...
  const result = await col1.aggregate([
    ...
    {
      $set: {
        'UOM': '$joinedData.Unidad_Medida_UOM',
        'UOM_Base': '$joinedData.Desc_Empaque_UOM_Base',
        'Unidades_Empaque': '$joinedData.Unidades_Empaque',
        'Calculo_Demanda': '$joinedData.Calculo_Demanda',
    ...
    await col1.updateOne(
      { _id: doc._id },
      {
        $set: {
          ...
          Unidades_Empaque: doc.Unidades_Empaque,
          Calculo_Demanda: doc.Calculo_Demanda,
