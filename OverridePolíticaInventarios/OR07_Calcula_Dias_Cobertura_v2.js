...
async function calcularDiasCobertura() {
  ...
  try {
    ...
    const diasCobertura = inventarios01.map((inventario) => ({
      ...
      SS: inventario.Demanda_Promedio_Diaria === 0 ? -1 : Math.ceil(inventario.SS_Cantidad / inventario.Demanda_Promedio_Diaria),
      ...
      ROP: inventario.Demanda_Promedio_Diaria === 0 ? -1 : Math.ceil(inventario.ROP / inventario.Demanda_Promedio_Diaria),
