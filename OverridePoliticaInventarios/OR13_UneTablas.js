...
async function crearTablaPoliticaInventarios() {
  ...
  try {
    ...
    // Obtener los datos de la colección y procesarlos
    ...
    const politicaInventarios = datosDemanda.map((dato) => {
      return {
        ...
        SS_Cantidad: dato.Override_SS_Cantidad || dato.SS_Cantidad,  // Usar Override_SS_Cantidad si está presente
        ROP: dato.Override_ROP || dato.ROP,  // Usar Override_ROP si está presente
