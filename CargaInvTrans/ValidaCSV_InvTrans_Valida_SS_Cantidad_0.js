...
const csvPath = `../../${parametroFolder}/reportes/InvTrans_PolInv_SKU_SS_Cantidad_0.csv`;
...
async function main() {
  ...
  try {
    ...
    const ColeccionRespaldo = db.collection('report_invtrans_vs_polinv_ss_cantidad_0');
