...
const logFile = `../../${parametroFolder}/log/Override_PlanReposicion.log`; 
...
async function actualizarDatos() {
  //writeToLog('------------------------------------------------------------------------------');
  writeToLog(`\nPaso 01 - Recalculo del Plan de Reposicion en Costo`);
  ...
  writeToLog(`\tTermina el Recalculo del Plan de Reposicion en Costo`);
  } catch (error) {
    // Manejar el error
