...
const archivos = [
  { nombre: '00_Verifica_Folders_v2.js', parametros: `${parametroFolder}` },
  { nombre: '01_Crea_uservars_v3.js', parametros: `${parametroFolder} ${var_AppUser} ${var_AppPassword} ${var_Type} ${var_DBUser} ${var_DBPassword} ${var_DBName} "${var_UserName}" "${var_UserTitle}" "${var_UserCompany}"` }
];
